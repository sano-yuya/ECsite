...
public class CreateUserConfirmAction extends ActionSupport implements SessionAware {
	...
	private String checkUserInfoErrorMessage;
	...
	public String execute() {
		...
		//ユーザーIDが使用可能か確認し可能であればパスワードを隠すためのメソッドを使用
		if (userInfoDAO.isCheckUser(userId)) {
			checkUserInfoErrorMessage = "使用できないユーザーIDです。";
		} else {
	...
	public String getCheckUserInfoErrorMessage() {
		return checkUserInfoErrorMessage;
	}

	public void setCheckUserInfoErrorMessage(String checkUserInfoErrorMessage) {
		this.checkUserInfoErrorMessage = checkUserInfoErrorMessage;
	}
